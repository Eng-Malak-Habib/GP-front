<template>
    <div class="addclient" id="parent">
        ...
        <form class="inputs" id="inputs" @submit.prevent="lawyerInsert">
...
<script type="text/javascript">
    ...
    methods:{
        lawyerInsert(){
                axios.post('https://ec2-54-196-138-182.compute-1.amazonaws.com/my_GP/api-passport/public/api/lawyers',this.form)
                .then(()=>
                {
                    this.$router.push({name:'profile'})
                    Toast.fire({ icon: 'success', title: 'Lawyer Inserted Successfully',})
                    })
                .catch(error=>{
